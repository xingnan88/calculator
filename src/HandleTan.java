...
//´úÂë13 HandleTan.java
import java.util.LinkedList;
import javax.swing.*;
import java.awt.event.*;
public class HandleTan implements ActionListener{
    LinkedList<String> list;
    JTextField resultShow,showComputerProcess;          
    JTextArea saveComputerProcess; 
    HandleTan(LinkedList<String> list,JTextField t1,JTextField t2,
                    JTextArea t3){
        this.list=list;
        resultShow=t1;
    ...
    public void actionPerformed(ActionEvent e){
       if(list.size()==1||list.size()==2){
           ...
           try{  double x=Double.parseDouble(numOne);
                 ...
                 String proccess="tan("+numOne+")="+result;
           ...
           try{  double x=Double.parseDouble(numTwo);
                 ...
                 list.set(0,str);
                 resultShow.setText(str);
                 String proccess="tan("+numTwo+")="+result;
                 showComputerProcess.setText(proccess);
                 saveComputerProcess.append(" "+proccess+"\n");
