...
public class CalculatorWindow extends JFrame implements ActionListener
{
	...
	JButton 小数点操作, 正负号操作, 退格操作, 等号操作, 清零操作, sin, cos, sqrt, tan, pow;
	...
	public CalculatorWindow()
	{
		...
		saveComputerProcess.setFont(new Font("宋体", Font.PLAIN, 20));
